                    ...
                    for($i=0;$i<count($res);$i++){
                        $html.='<tr>
                                    ...
                                    <td style="display:flex;justify-content:space-between;align-items:center">
                                        ...
                                        <i class="btn btn-primary fa fa-paper-plane pointer" onclick="sendAddendum('.$res[$i]['RowID'].')"></i>
                                    </td>
                                </tr>';
                    }
...
/*        $ut = new Utility();
    ...
    public function select_receivers_id_related_barname($pid,$meta_data)
    {
        $db = new DBi();
        $ut = new Utility();
		$acm = new acm();
