...
async function editCreatePrpertyManageFrom(values = {}) {
  ...
  <div class="d-flex justify-content-between p-4 border-top">
    <button type="button" class="btn btn-primary" id="doEditCreatePropertyManage_btn" onclick="doEditCreatePropertyManage()">ایجاد</button>
    <button type="button" class="btn btn-danger" id="abort" onclick="close_modal()">انصراف</button>
  </div>
...
async function doEditCreatePropertyManage() {
  ...
  for (var k = 0; k < prop_doc_file.length; k++) {
    // file_upload.push(prop_doc_file[k])
