   ...
   if(edit==0){
    var seller_td="";
        ...
        <td id="last_inq_result_${good_id}">
            ...
            <button onclick="add_last_inq(${good_id})" class="btn btn-warning">افزودن آخرین  استعلام</button>
        </td>
...
function add_last_inq(good_id){
    ...
    var modal=`<div class="modal" tabindex="-1" role="dialog" id="last_inq_modal">
                <div class="modal-dialog" role="document" style="max-width:800px">
                      ...
                      <form id="inq_detailes_form" style="">
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" onchange="get_seller_detailes(this,0)"  id="inq_seller_selcect">${seller_options}</select>
                                </div>
                            </div>
                            <div class="col-sm-6">
                            <div class="col-sm-12">
                    ...
                    <div id="last_inq_detailes">
                        ...
                        <div class="row form-group">    
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" onkeyup="set_septaror(this)" type="text" id="last_unit_price">
                                </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row form-group">
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control"  type="text" id="last_price_valid">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6" id="rent_div">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control"  type="text" id="last_rent">
                                </div>
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <input onkeyup="set_septaror(this)" class="form-control"  type="text" id="last_ultimate_price">
                                </div>
                            </div>
                            <div class="col-sm-6">
                    ...
                    <div class="modal-footer">
                        <button type="button" onclick="save_last_inq()" class="btn btn-primary">تایید </button>
                        <button type="button" class="btn btn-danger" onclick="close_modal('inq_detailes_form')" data-dismiss="modal">انصراف</button>
                    </div>
                    </div>
                </div>
                </div>`
...
async function get_seller_detailes(input,status=0){
    ...
    if(res.res=="true"){
        if(res.data.length){
            if(status==0){
                $("#pri_origin_of_send").val(res.data.ostan)
                $("#city_origin_of_send").val(res.data.ostan)
                $("#seller_phon").val(res.data.phone)
            }
            $("#pri_origin_of_send").attr('disabled',true)
            $("#city_origin_of_send").attr('disabled',true)
            $("#seller_phon").attr('disabled',true)
        }
    }
