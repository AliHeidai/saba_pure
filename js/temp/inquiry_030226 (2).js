    ...
    if(result.length>0 && !$(input).attr('fetch')){
        for (var j = 0; j < result.length; j++)
        {
            ...
            var temp_seller_name={
                ...
                'value': result[j]['temp_seller_name'] ? result[j]['temp_seller_name'] : ""
            ...
            create_form_element("#form_create_seller_row_" + form_index,temp_seller_name);
           ...
           create_form_element("#form_create_seller_row_" + form_index, inq_good_deliver_time);
            ...
            $("#inq_good_deliver_time_"+form_index).val(result[j]['good_deliver_time'])
           //------------------------------------------------------------------------
           if($("#export_inq_seller_name_" + form_index).val()=='7316'){
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span style="color:red;font-size:1rem" aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form>
      ...
      <div class="modal-footer">
      <button type="button" class="btn btn-primary" onclick="attach_inq_file(${group_code},${inq_id})">ذخیره</button>
        <button type="button" class="btn btn-secondary" data-dismiss="modal">انصراف</button>
    ...
    var params=
        {
            ...
            inq_good_quantity:inq_good_quantity,export_inq_seller_name:export_inq_seller_name,temp_seller_name:temp_seller_name,export_good_quantity:export_good_quantity,
            ...
            inq_good_buy_request_num:inq_good_buy_request_num,inq_good_desc:inq_good_desc,buy_base_desc:buy_base_desc,inq_good_deliver_time:inq_good_deliver_time
        }
    var res = await manageAjaxRequestCustom(params);
    if(res.data>0){
