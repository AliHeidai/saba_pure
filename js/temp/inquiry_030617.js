    ...
    for(m in selected_goods){
        $("#inq_table").append(`<tr id="row_${selected_goods[m]['good_id']}" good_name="${selected_goods[m]['good_desc']}">
                                    <td style="min-width:300px;padding:5px">
                                        ...
                                        <div class="form-group-custom">
                                            <label>واحد</label>
                                            <select class="form-control" > <option value="0"> انتخاب نمایید </option></select>
                                        </div>
...
function insert_select_sellers(){
    ...
    for(var i=0;i<selected_sellers.length;i++){
        ...
        <div class="container">
            <div class="row">
                <h6 style="min-height:100%;height:100%" class="text-center col-md-10">نام مشتری  :${selected_sellers[i]['seller_name']} </h5>
