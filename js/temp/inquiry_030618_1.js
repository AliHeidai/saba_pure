...
function set_persian_date(element){
    var element_id="#"+$(element).attr('id')
    $(element).MdPersianDateTimePicker({
        targetTextSelector: element_id,
        disableAfterDate: new Date(),
    })
}

function swal_custom(title,text,type){
    var msg_type="";
    switch(type){
        case "e":
            msg_type="error";
...
async function goToPurchaseInquiry(){
    ...
    `<ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="temp_inqs-tab" data-bs-toggle="tab" data-bs-target="#temp_inqs" type="button" role="tab" aria-controls="temp_inqs" aria-selected="true">استعلام های موقت</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="ready_inqs-tab" data-bs-toggle="tab" data-bs-target="#ready_inqs" type="button" role="tab" aria-controls="ready_inqs" aria-selected="false"> استعلام های آماده ارسال</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="varede_inqs-tab" data-bs-toggle="tab" data-bs-target="#varede_inqs" type="button" role="tab" aria-controls="varede_inqs" aria-selected="false">استعلام های وارده</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="saderh_inqs-tab" data-bs-toggle="tab" data-bs-target="#saderh_inqs" type="button" role="tab" aria-controls="saderh_inqs" aria-selected="false">استعلام های صادره</button>
        </li>
    </ul>
    <div class="tab-content" id="myTabContent">
        <div class="inq-section tab-pane fade show active" id="temp_inqs" role="tabpanel" aria-labelledby="temp_inqs-tab"> 
            <div class="text-left p-8 inq_temp_headeing">
                <button id="add_inq" onclick="create_new_inquiry()" class="btn btn-primary">ایجاد استعلام جدید </button>
            </div>
            <div id="temp_inq_detailes"></div>
        </div>
        <div class="inq-section tab-pane fade" id="ready_inqs" role="tabpanel" aria-labelledby="ready_inqs-tab"></div>
        <div class="inq-section tab-pane fade" id="varede_inqs" role="tabpanel" aria-labelledby="varede_inqs-tab"></div>
        <div class="inq-section tab-pane fade" id="saderh_inqs" role="tabpanel" aria-labelledby="saderh_inqs-tab"></div>
    </div>`;
      ...
      <div class="modal-content">
        ...
        <form class="w-100">
           ...
           <!-- <div class="form-group  py-2 ">
                ...
                <textarea class="form-control" id="inq_description" placeholder="توضیحات"></textarea>
            </div>-->
      </form>
...
async function  open_inq_manage(input,id,status){
    ...
    var modal=`<
    <div id="inq_detailes" class="modal" tabindex="-1">
    <input type="hidden" value="${id}" id="inq_id_hidden" >
  <div class="modal-dialog" style="max-width:100vw;">
    <div  background:#f4f6f9;" class="modal-content ">
      <div class="modal-header text-light bg-primary-custom">
        <h5 class="modal-title">فرم  مدیریت استعلام بها</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span class="text-danger h3" aria-hidden="true">X</span>
        </button>
      </div>
      <div class="modal-body" style="overflow:scroll;background:#f4f6f9">
        ...
        <div id="inq_detailes">
            <div class="row justify-content-around" id="add_good_row">
                <button id="add_good_row" onclick="add_good_inq(this)" class="w-100 btn btn-success col-md-4"> افزودن محصول جهت استعلام </button>
                <button disabled onclick="add_seller()" id="add_seller_btn"  title="افزودن فروشنده" class="btn btn-info col-md-4">افزودن فروشنده</button>
            </div>
           <div class="row">
            <table id="inq_tbl_main" style="overflow:scroll;margin:1rem auto;display:none" border="1" >
            <tr>
                <td colspan="20">
                    <table border="1" id="inq_table" class="table-border" >
                        <thead>
                            <tr>
                                <th style="width:330px">مشخصات  کالا</td>
                                <th style="width:300px">اطلاعات آخرین خرید</td>
   ...
   // if(!$("#PurchaseInquiry").length){
        $("#PurchaseInquiry").append(modal)
    //}
    $("#inq_detailes").modal({backdrop:'static',keyboard:false},'show')
...
function add_seller(){
    ...
    for(m in seller_array){
        ...
        // `<tr>
        //         <td>${counter}</td>
        //         <td>${seller_info['code']}</td>
        //         <td>
        //         <label class="row m-0"><input type="checkbox"s_id="${seller_info['RowID']}"> <span class="p-2">${seller_info['Name']} </span></label>
        //             <!--<label class="d-flex">
        //                 <span class="ml-2">
        //                     <input type="checkbox" s_id="${seller_info['RowID']}" >
        //                 </span>
        //                 <span>${seller_info['Name']}</span>
        //             </labe>-->
        //         </td>
                
        //         <td>${seller_info['address']?seller_info['address']:""}</td>
        //     </tr>`;
        // counter++;
    }
    ...
    <div class="modal-dialog" role="document" style="max-width:900px">
        ...
        <div class="modal-body">
            <div class="modal-body">
                <div class="form-group row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">انتخاب طرف حساب </label>
                    <div class="col-sm-10">
                        <select  onchange="toggleSelectSeller(this)" id="inq_seller_selcect">${seller_options}</select>
                    </div>
                </div>
        ...
        <div class="modal-footer">
            <button onclick="insert_select_sellers()" type="button" class="btn btn-primary">تایید</button>
        </div>
        </div>
    </div>
</div>`;
...
async function add_good_inq(btn_input){
    var goods= await get_all_goods();
    var options=`<option value="-1">انتخاب نمایید</option>`;
    var btn_input_id=$(btn_input).attr('id')
    ...
    for(k in goods){
        options+=
        `<option value="${goods[k]['RowID']}" good_code="${goods[k]['code']}">${goods[k]['title']}</option>`
    }
    if($("#select_goods_modal").length){
        $("#select_goods_modal").remove()
    }
   ...
   `<div id="select_goods_modal" class="modal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document" style="max-width:600px">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    <label for="inq_good_selcect" class="col-sm-2 col-form-label">انتخاب کالا</label>
                    <div class="col-sm-10">
                        <select  onchange="toggleSelectGoods(this)" id="inq_good_selcect">${options}</select>
                    </div>
                </div>
                <div id="selected_goods"></div>
            </div>
            <div class="modal-footer">
                <button onclick="insert_select_goods('${btn_input_id}')" type="button" class="btn btn-primary">تایید</button>
            </div>
            </div>
        </div>
    </div>`;
    ...
    await select_data_picker($("#inq_good_selcect"),1)
    $("#select_goods_modal").modal({backdrop:'static',keyboard:false},'show')
   
}

function toggleSelectSeller(chk){
    if($(chk).val()!==-1){
        var selected_seller_rows='';
        var seller_id=$(chk).val()
        var seller_tafzili=$(chk).find('option:selected').attr('tafzili')
        var seller_name=$(chk).find('option:selected').text()
        var seller_addres=$(chk).find('option:selected').attr('seller_address')
        
        selected_seller_rows=`<tr seller_id="${seller_id}" seller_tafzili="${seller_tafzili}" ><td class="row_number">1</td><td>${seller_tafzili}</td><td>${seller_name}</td><td><i class="btn btn-danger fa fa-trash" onclik="delete_selected_seller_row(${seller_id})"></i></td></tr>`
        if(!$("#selected_seller_table").length){
            ...
            <thead>
                ...
                <th style="width:30%">کد تفضیلی</th>
                <th style="width:65%"> نام مشتری </th>
                <th style="width:65%">حذف </th>
            </thead>
            <tbody>
...
function insert_select_goods(){
    ...
    var appended_td="";
    // for(var i=1;i<th_count;i++){
    //     appended_td+="<td style='min-width:200px'></td>"
    // }
    ...
    for(m in selected_goods){
        $("#inq_table").append(`<tr id="row_${selected_goods[m]['good_id']}" good_name="${selected_goods[m]['good_desc']}">
                                    <td style="min-width:300px;padding:5px">
                                        ...
                                        <div class="form-group-custom">
                                            <label>واحد</label>
                                            <select class="form-control" id="good_unit" > ${unit_options}</select>
                                        </div>
                                        
                                        <div class="form-group-custom">
                                            <label> مبنای درخواست</label>
                                            <select id="get_base_of_inq" class="form-control"> ${base_of_inq_option}</select>
                                        </div>
                                        <div class="form-group-custom">
                                    ...
                                    <td style='min-width:200px'>
                                         <div class="form-group-custom">
                                            <label>فروشنده</label>
                                            <select id="get_base_of_inq" class="form-control"> </select>
                                        </div>
                                        <fieldset style="
    background-color: inherit;
    height: 3.7rem;
    border: 1px solid rgb(133, 71, 71);
    width: 100%;
    border-radius: 5px;
    margin-block: 13px;
">
                                        <legend style="font-size: 1rem !important;width: auto !important;color: rgb(122, 167, 122);">ارائه فاکتور با ارزش افزوده</legend>
                                        <label> <input type="radio" > بله</label>
                                        <label> <input type="radio" > خیر</label>
                                        </fieldset>
                                        <div class="form-group-custom">
                                            <label>قیمت با / بدون ارزش افزوده</label>
                                            <input  class="form-control" type="text" >
                                        </div>
                                        <div class="form-group-custom">
                                            <label>   (بر اساس روز)مدت باز پرداخت</label>
                                            <input  class="form-control" type="text" >
                                        </div>
                                        <div class="form-group-custom">
...
function get_citeis(input,index){
    ...
    $("#city_origin_of_send_"+index).html(city_option);
}

function insert_select_sellers(){
    var selected_sellers=[]
    var obj={};
    $("#selected_seller_table tbody tr").each(function(){
        obj.seller_id=$(this).attr('seller_id');
        obj.seller_name=$(this).find("td:eq(2)").text();
        selected_sellers.push(obj);
        obj={}
    })
    ...
    // for(c in city){
    //     option_city+=`<option value="${province[c].RowID}">${province[c].title}</option>`
    // }
    ...
    for(var i=0;i<selected_sellers.length;i++){
        ...
        <div class="container">
            <div class="custom_row">
                    ...
                    <h6 style="min-height:100%;height:100%" class="text-right col-md-10">نام مشتری  :${selected_sellers[i]['seller_name']} </h5>
                
                
                    <button onclick="delete_seller_column(this,${selected_sellers[i]['seller_id']},${$("#inq_id_hidden").val()})" class="col-md-2 btn btn-danger">حذف </button>
                
            </div>
            <div class="py-5">
                <div class="form-group-custom ">
                    <label "> استان</label>
                    <select class="form-control" id="pri_origin_of_send_${i}" onchange="get_citeis(this,${i})">
                        <option value="0"> انتخاب استان</option>
                        ${option_privonce}
                    </select>
                </div>
                <div class="form-group-custom ">
                    <div class="inline-label"> شهرستان</div>
                    <select class="form-control" id="city_origin_of_send_${i}">
       ...
       appended_td+=`<th class="inq_detailes_th" style='width:300px'>${td_text}</th>`
    appended_tbody_td+=`<td style='min-width:300px;min-height:300px'>
                                ...
                                <div style="min-height:300px;height:auto">
                                    ...
                                    <button id="more_seller_data_${selected_sellers[i]['seller_id']}" onclick="register_inq_detailes(this,'${selected_sellers[i]['seller_name']}')" class='btn btn-success'>ثبت/ویرایش جزییات</button>
                                </div>
                            </td>`
        $("#select_sellers_modal").hide();
    }
    
   // if(!$("#inq_table thead tr").find("th.inq_detailes_th").length){
        $("#inq_table thead tr").append(appended_td);
   // }
   
    $("#inq_table tbody tr").append(appended_tbody_td);
...
function delete_seller_column(input,seller_id,inq_id){
    Swal.fire({
        title: "حذف",
...
async function register_inq_detailes(input,seller_name){
    var input_id=$(input).attr('id');
   var tid= $("#"+input_id).parent().closest('tr').attr('id');

    var good_name = "";//await $(good_name_tr).attr('good_name')
    ...
    <div id="seller_inq_detailes" class="modal custom_modal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
            <div class=" bg-primary text-light modal-header">
                <h5 class="modal-title"><span> نام طرف حساب :${seller_name}</span></h5>
                <button type="button" class="close" id="close_modal_reg">
            ...
            <div class="modal-body form_custom_bg">
                <form>
                    <div class="form-group-custom">
                        <label>قیمت با /بدون ارزش افزوده</label>
                        <input class="form-control" type="text" id="inq_price">
                    </div>
                    <div class="form-group-custom">
                        <label> مدت بازپرداخت</label>
                        <input class="form-control" type="text" id="pay_long">
                    </div>
                     <div class="form-group-custom">
                        <label> تاریخ تحویل</label>
                        <input class="form-control" type="text" id="deliver_date">
                    </div>
                    <div class="form-group-custom">
                        <label>  اعتبار قیمت</label>
                        <input class="form-control" type="text" id="price_validate">
                    </div>
                    <div class="form-group-custom">
                    ...
                    <div class="form-group-custom">
                        <label> توضیحات </label>
                        <textarea class="form-control"  id="inq_desc"></textarea>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
    ...
    $("#close_modal_reg").on("click",function(){
        $("#seller_inq_detailes").modal('hide')
        $(".modal-backdrop").hide();
    })
}
//------------------------------------------------------------------
