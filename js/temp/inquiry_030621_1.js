...
async function goToPurchaseInquiry(){
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="inq-section tab-pane fade" id="inquiry_detailes" role="tabpanel" aria-labelledby="inquiry_detailes"></div>
    </div>`;
      ...
      <div class="modal-body" style="overflow:scroll;background:#f4f6f9">
        ...
        <div id="inq_detailes">
           ...
           <div class="row">
            ...
            <tr>
                <td colspan="20">
                    <table border="1" id="inq_table" class="table-border table-striped" >
                        <thead>
                            <tr>
...
$("#PurchaseInquiry div#inquiry_detailes").append(modal)
display_inq_section($("#inquiry_detailes"))
    //}
    ...
    if(count_th>2){
        $("#inq_table thead tr th").each(function(){
            if($(this).index()>1){
                ...
                td_add+=`<td style='min-width:300px;min-height:300px'>
    ...
    for(var i=0;i<selected_sellers.length;i++){
        ...
        <div class="container">
            ...
            <div class="py-5">
                <fieldset class="form-group-custom ">
                    <legend "> استان</legend>
                    <select  id="pri_origin_of_send_${index}" onchange="get_citeis(this,${index})">
                        <option value="0"> انتخاب استان</option>
                        ${option_privonce}
                    </select>
                </fieldset>
                <fieldset class="form-group-custom ">
                    <legend "> شهرستان</legend>
                    <select  id="city_origin_of_send_${index}">
                        
                    </select>
                </fieldset>
            </div>
            <input type="hidden" id="seller_hidden_id_${selected_sellers[i]['seller_id']}" value="${selected_sellers[i]['seller_id']}">
            <input type="hidden" id="seller_hidden_name_${selected_sellers[i]['seller_id']}" value="${selected_sellers[i]['seller_name']}">
...
async function register_inq_detailes(input,seller_name){
    ...
    var good_name= $("#"+input_id).parents('tr').attr('good_name');
   // var good_name = "";
    ...
    <div id="seller_inq_detailes" class="modal custom_modal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            ...
            <div class=" bg-primary text-light modal-header" ${bgColorStyle}>
             ...
             <h5 class="modal-title row justify-content-between"><span> نام طرف حساب :${seller_name}</span> <span>شرح کالا : ${good_name}</span></h5>
            <div class="modal-body form_custom_bg">
                <form>
                    <fieldset class="form-group-custom">
                        <legend>قیمت با /بدون ارزش افزوده</legend>
                        <input  type="text" id="inq_price">
                     </fieldset>
                    <fieldset class="form-group-custom">
                        <legend> مدت بازپرداخت</legend>
                        <input  type="text" id="pay_long">
                     </fieldset>
                     <fieldset class="form-group-custom">
                        <legend> تاریخ تحویل</legend>
                        <input  type="text" id="deliver_date">
                   </fieldset>
                    <fieldset class="form-group-custom">
                        <legend>  اعتبار قیمت</legend>
                        <input  type="text" id="price_validate">
                    </fieldset>
                    <fieldset class="form-group-custom">
                        <legend>   کرایه حمل</legend>
                        <input  type="text" id="price_validate">
                     </fieldset>
                    <fieldset class="form-group-custom">
                        <legend>   قیمت تمام شده</legend>
                        <input  type="text" id="price_validate">
                  </fieldset>
                    <fieldset class="form-group-custom">
                        <legend> توضیحات </legend>
                        <textarea   id="inq_desc"></textarea>
                     </fieldset>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" ${bgColorStyle}>تایید</button>
            </div>
            </div>
        </div>
    </div>`;
