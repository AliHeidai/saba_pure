...
async function  open_inq_manage(id,status){
   ...
   //-----------------------------------------------
    ...
    var send_inq_btn=`<button ${disable} onclick="send_inq(${id},${status})" id="send_inq_btn"  title="گردش کار/ارسال" class="btn btn-primary col-md-1 mx-2">ارسال</button>`
