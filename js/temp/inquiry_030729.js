...
async function goToPurchaseInquiry(){
    ...
    `<ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation" style="position:relative">
            <button class="nav-link inq_active inq_tab" id="temp_inqs-tab" data-bs-toggle="tab" data-bs-target="#temp_inqs" type="button" role="tab" onclick="get_inquires(0,'temp_inq_detailes')" aria-selected="true">استعلام های موقت</button>
            <span class="inq_count" id="inq_count_temp">0</span>
        </li>
        <li class="nav-item" role="presentation" style="position:relative">
            <button class="nav-link inq_tab" id="ready_inqs-tab" data-bs-toggle="tab" data-bs-target="#ready_inqs" type="button" role="tab" aria-controls="ready_inqs" onclick="get_inquires(1,'temp_inq_detailes')" aria-selected="false"> استعلام های آماده ارسال</button>
            <span class="inq_count" id="inq_count_ready">0</span>
        </li>
        <li class="nav-item" role="presentation" style="position:relative">
            <button class="nav-link inq_tab" id="varede_inqs-tab" data-bs-toggle="tab" data-bs-target="#varede_inqs" type="button" role="tab" aria-controls="varede_inqs" onclick="get_inquires(2,'temp_inq_detailes')" aria-selected="false">استعلام های وارده</button>
            <span class="inq_count" id="inq_count_varede">0</span>
        </li>
        <li class="nav-item" role="presentation" style="position:relative">
            <button class="nav-link inq_tab" id="saderh_inqs-tab" data-bs-toggle="tab" data-bs-target="#saderh_inqs" type="button" role="tab" aria-controls="saderh_inqs"  onclick="get_inquires(3,'temp_inq_detailes')""aria-selected="false">استعلام های صادره</button>
            <span class="inq_count" id="inq_count_sadereh">0</span>
        </li>
         <li class="nav-item" role="presentation" style="position:relative">
            <button class="nav-link inq_tab" id="confirmed_inqs-tab" data-bs-toggle="tab" data-bs-target="#last_confirmed_inqs" type="button" role="tab" aria-controls="saderh_inqs"  onclick="get_inquires(20,'temp_inq_detailes')""aria-selected="false">استعلام های تایید شده</button>
            <span class="inq_count" id="inq_count_confirmed">0</span>
        </li>
        <li class="nav-item" role="presentation" style="position:relative">
            <button class="nav-link inq_tab" id="confirmed_inqs-tab" data-bs-toggle="tab" data-bs-target="#archived_inqs" type="button" role="tab" aria-controls="saderh_inqs"  onclick="get_inquires(10,'temp_inq_detailes')""aria-selected="false">استعلام های  بایگانی شده</button>
            <span class="inq_count" id="inq_count_confirmed">0</span>
        </li>
  ...
  get_inquires(0,'temp_inq_detailes')
...
function get_inquires(status,selector,page=1,other_params={},is_search=0){
    ...
    switch(status){
        case "0":
        case 0:
            selector="#temp_inqs-tab";
            break;
        case "1":
        case 1:
            selector="#ready_inqs-tab";
            break;
        case "2":
        case 2:
            selector="#varede_inqs-tab";
            break;
        case "3":
        case 3:
            selector="#saderh_inqs-tab";
            break;
        case "10":
        case 10:
            selector="#confirmed_inqs-tab";
            break;
        case 20:
        case "20":
            selector="#archived_inqs-tab";
            break;
                                            
    }
    $(".inq_tab").removeClass('inq_active');
    $(selector).addClass('inq_active');
}
...
function search_inquiry(input,status)
{
    ...
    if((inq_to=="" && inq_from=="") ||(inq_to && inq_from)){
        ...
        get_inquires(status,'temp_inq_detailes',1,other_params,1)
...
async function archive_inq(id){
    var  conf= await swal_custom('','استعلام بایگانی شود؟','c');
    if(conf==1){
        var action='archive_inq'
        var res=manageAjaxRequestCustom({action:action,inq_id_id});
        if(res.res=="true"){
            get_inquires(0,'temp_inq_detailes');
        }
        else{
...
function goto_export_inq_list(input){
    ...
    go_to_section(get_inquires,0,'temp_inqs-section')
