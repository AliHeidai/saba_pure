...
function add_seller_buyer_save()
{
    ...
    $result = $inq->save_inquiry_detailes($inq_good_name, $inq_good_quantity_unit, $inq_good_quantity,$inq_good_buy_request_num,$inq_good_desc,$buy_base_desc,
        ...
        $export_rent_outside, $seller_group_code,$inq_id,$export_cash_section,$export_term_payment,$export_description,$is_vat
    );
...
function print_inq(){
    ...
    $result = $inq->print_inq($_POST['inq_id']);
    // $res = $result;
    if ($result) {
        $out = "true";
        $res = $result;
