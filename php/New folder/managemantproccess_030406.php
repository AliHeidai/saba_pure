...
function payCommentReportExcel(){
    ...
    $hdarray = array('کد یکتا','نوع','تاریخ ثبت','در وجه','کد تفضیلی','بابت','مبلغ','نقدی','چک','توضیحات');
    $fieldNames = array('unCode','sendType','cDate','accName','codeTafzili','Toward','Amount','CashSection','NonCashSection','desc');
