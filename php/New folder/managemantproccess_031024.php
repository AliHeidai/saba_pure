...
function doEditCreatePersonnel(){
    ...
    list($pid,$Fname,$Lname,$fatherName,$Pcode,$birthDate,$RecruitmentDate,$Sdate,$Edate,$phone,$mobile,$TermContract,$monthTrial,
         ...
         $hourlyWages,$avgDayInMonth,$dailyDutyWorkingHours) = $uti->varCleanInput(array('pid','Fname','Lname','fatherName','Pcode','birthDate','RecruitmentDate','Sdate','Edate','phone','mobile','TermContract','monthTrial','BCertificate',
                                                                                         'Issued','NationalCode','MaritalStatus','personnelRightMarry','Address','insuranceNumber','AccountNum','EvaluationScore','Unit','dailyWages','YearsCost','RightHousing',
...
function doEditCreateComment(){
    ...
    list($cid,$pMethod,$pType,$Unit,$consumerUnit,$Type,$Toward,$totalAmount,$Amount,$AccNum,$CashSection,$MaturityCash,$NonCashSection,$MaturityCheck,$RequestSource,$RequestNumbers,$Desc,$billID,$payID,$layer1,$layer2,$cFund,$cForv,$code,$ContractNum,$CheckNumber,$CheckDate,$DeliveryDate,$CheckCarcass,$CardNumber,$layer3,$goodLoan,$checkOutType,$related_project,$related_vat,$is_drivers_fare,$is_drivers_fare_type,$PropertyNumber,$creditName) = $uti->varCleanInput(array('cid','pMethod','pType','Unit','consumerUnit','Type','Toward','totalAmount','Amount','AccNum','CashSection','MaturityCash','NonCashSection','MaturityCheck','RequestSource','RequestNumbers','Desc','billID','payID','layer1','layer2','cFund','cForv','code','ContractNum','CheckNumber','CheckDate','DeliveryDate','CheckCarcass','CardNumber','layer3','goodLoan','checkOutType','related_project','related_vat','is_drivers_fare','is_drivers_fare_type','PropertyNumber','creditName'));
    $files = $_FILES['files'];
    $Amount = str_replace(',','',$Amount);
